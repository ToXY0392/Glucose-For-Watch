---
name: widget-g7-dependabot-triage
description: Triages Dependabot PRs for Glucose For Watch — small scoped merges, no feature bloc mixing, coordinates with widget-g7-dependency-advisor. Use when Dependabot opens PRs or when reviewing dependency upgrades.
...
2. **AGP / Gradle / Kotlin major bumps** — invoke `widget-g7-dependency-advisor` first; may need compat matrix update (`widget-g7-compat-matrix-maintainer`).
