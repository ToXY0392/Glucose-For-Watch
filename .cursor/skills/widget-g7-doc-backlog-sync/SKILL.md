---
name: widget-g7-doc-backlog-sync
...
**Pair with:** `widget-g7-github-project-sync` (Monday) · `widget-g7-doc-drift-checker` (monthly)
...
| DOC-P1-1 | CONTRIBUTING mentions `widget-g7-pr-author` + `widget-g7-pr-gatekeeper` |
| DOC-P1-2 | PR template hints `@widget-g7-pr-author` |
...
1. `@widget-g7-doc-backlog-sync`
2. `@widget-g7-github-project-sync`
