---
name: widget-g7-mobile-app-scope
description: >-
  Scope-limited work on workspace/mobile-app — mobile module only. Use when
  checked out on workspace/mobile-app or when the user asks for phone-only
...
Expected: **`workspace/mobile-app`**. Warn if branch mismatch.
