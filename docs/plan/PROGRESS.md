...
> **Phase en cours :** **3** — Release prep (hardware QA parallèle)  
...
Phase 0   ██████████████████░░   95%  ✅ Correctifs P0 (QA hardware restante)
Phase 1   ████████████████████  100%  ✅ Kit intégré
Phase 2   ████████████████████  100%  ✅ Sync robuste + tests mock
Phase 3   ████████████████░░░░   80%  🔄 QA hardware G6/G7
─────────────────────────────────────────────
Total     ███████████████████░   ~90%  (26/29 tâches)
```
...
| App | v0.4.0 |
| Kit UX | v0.1.0 |
| Prochaine tâche | **0.7** QA hardware (brancher phone+watch) · matrice [QA-MATRIX-G6-G7.md](QA-MATRIX-G6-G7.md) |
...
| **M0** | 2026-05-31 | Tile sync + AGP + badge offline | ✅ code · ☐ QA 30 min |
| **M1** | 2026-06-14 | Tokens ToXY intégrés dans l’APK | ✅ |
| **M2** | 2026-06-28 | Rattrapage offline 2 h | ✅ code · ☐ QA 2 h |
| **M3** | 2026-07-19 | Release v0.4.0 | ✅ tag · ☐ QA sign-off |
...
| 0.7 | **QA manuelle 30 min + offline 1 h** | ☐ | **À faire sur téléphone + montre** |

### Checklist QA Phase 0 (0.7)

Cocher après test réel (install : `.\scripts\qa\install-and-verify.ps1`) :
...
| 1.3 | AGP sur complication | 🔄 | RANGED_VALUE 40–400 ; teinte texte → limit API 1.2.x |
...
| **0.7** | **QA manuelle 30 min + offline 1–2 h** | ☐ **← PROCHAINE (hardware)** | Téléphone + montre |
...
| # | Tâche | Statut |
|---|-------|--------|
| 3.1 | Figma ToXY (Chrome + AGP séparés) | ☐ |
| 3.2 | Wear status screen (Compose M3) | ✅ | `WearStatusScreen` + sync button |
| 3.3 | QA matrice G6 + G7 (14 cas) | 🔄 | Procédures → [QA-MATRIX-G6-G7.md](QA-MATRIX-G6-G7.md) |
...
- [ ] AGP sur complication (teinte = tile → Phase 2.5)
- [x] Kit tokens intégrés (pas de hardcode legacy glycémie)
- [x] Offline queue + reconnect flush (code)
- [ ] Offline 2 h → auto catch-up (QA hardware — gate M2)
- [ ] Matrice G6/G7 signée → [QA-MATRIX-G6-G7.md](QA-MATRIX-G6-G7.md)
