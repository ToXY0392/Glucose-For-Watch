...
class SyncGlucoseDisplayFormatterTest {
    ...
    fun home_fields_return_null_when_no_value() {
        ...
        assertNull(SyncGlucoseDisplayFormatter.homeValuePrimary(snapshot))
        assertNull(SyncGlucoseDisplayFormatter.homeReadingSummary(snapshot))
    ...
    fun home_primary_formats_with_unit() {
        ...
        assertEquals("100 mg/dL", SyncGlucoseDisplayFormatter.homeValuePrimary(snapshot))
    }
    ...
    fun home_summary_includes_translated_trend_and_age() {
        ...
        val computed = SyncGlucoseDisplayFormatter.homeReadingSummary(snapshot)
