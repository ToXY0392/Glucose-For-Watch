...
class ActiveGlucoseSyncService : Service() {
    ...
    companion object {
        ...
        private const val ACTION_START = "com.glucoseforwatch.mobile.sync.action.START_ACTIVE_SYNC"
        private const val ACTION_SYNC_NOW = "com.glucoseforwatch.mobile.sync.action.SYNC_NOW"
